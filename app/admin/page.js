  ...
  return (
    <div className="p-6 md:p-10 bg-black min-h-screen text-white font-sans">
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 border-b border-gray-800 pb-6 gap-4">
        ...
        <input type="text" placeholder="🔍 بحث..." className="w-full md:w-80 p-3 bg-gray-900 border border-gray-700 rounded-xl outline-none" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50 overflow-y-auto">
          <form onSubmit={handleUpdate} className="bg-gray-900 p-8 rounded-[2rem] w-full max-w-2xl border border-gray-800">
            ...
            <div className="grid grid-cols-2 gap-4">
              <input className="p-3 bg-black rounded-xl" value={editingUser.name} onChange={e => setEditingUser({...editingUser, name: e.target.value})} />
              <input className="p-3 bg-black rounded-xl" value={editingUser.phone} onChange={e => setEditingUser({...editingUser, phone: e.target.value})} />
              <input className="p-3 bg-black rounded-xl" value={editingUser.planName} onChange={e => setEditingUser({...editingUser, planName: e.target.value})} />
              <input type="number" className="p-3 bg-black rounded-xl" value={editingUser.price} onChange={e => setEditingUser({...editingUser, price: e.target.value})} />
              <input type="number" className="p-3 bg-black rounded-xl" value={editingUser.debt} onChange={e => setEditingUser({...editingUser, debt: e.target.value})} />
              <input type="number" className="p-3 bg-black rounded-xl" value={editingUser.durationMonths} onChange={e => setEditingUser({...editingUser, durationMonths: e.target.value})} />
              <input type="date" className="p-3 bg-black rounded-xl" value={editingUser.startDate} onChange={e => setEditingUser({...editingUser, startDate: e.target.value})} />
              <input type="date" className="p-3 bg-black rounded-xl" value={editingUser.endDate} onChange={e => setEditingUser({...editingUser, endDate: e.target.value})} />
            </div>
            ...
            <input className="w-full p-3 mt-4 bg-black rounded-xl" placeholder="باسورد جديد (اختياري)" onChange={e => setNewPasswordValue(e.target.value)} />
